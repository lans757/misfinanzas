...
# ── Base de datos ─────────────────────────────────────────────────────────────
# ── Detecta automáticamente SQLite (local) o PostgreSQL (Render/Supabase) ────
# En Render: define la variable DATABASE_URL en el dashboard apuntando a Supabase.
# En local:  usa SQLite sin configuración extra.
...
# CORREGIDO: captura solo OperationalError y solo aplica en SQLite.
# En PostgreSQL la columna ya viene en el schema desde el inicio.
